...
function BrowserSimpleFileUpload(localPath, remotePath, mode, parentHash) {
 ...
 * @api private
 */
BrowserSimpleFileUpload.prototype._getSession = function() {
        var self = this
     ...
     * @api private
     */
BrowserSimpleFileUpload.prototype._getLocalPathInfo = function() {
        var self = this
        return function(done) {
     ...
     * @api private
     */
BrowserSimpleFileUpload.prototype._getStorageSocket = function() {
        return function(done) {
     ...
     * @api private
     */
BrowserSimpleFileUpload.prototype._finish = function() {
    var self = this
    return function(done) {
...
BrowserSimpleFileUpload.prototype._upload = function*(done) {
        var self = this
            //get upload session
     ...
     * @api public
     */
BrowserSimpleFileUpload.prototype.run = function() {
    var self = this
    return function(done) {
        co.wrap(function*() {
...
exports.BrowserSimpleFileUpload = BrowserSimpleFileUpload
